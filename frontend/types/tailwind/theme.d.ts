declare namespace Tailwind {
  ...
  type ResolvePath = (path: string, defaultValue?: unknown) => any
  ...
  type CustomPalette = Record<string | symbol, ColorValue>

  type ColorValueFunc = (options: {
  ...
  type ColorValue =
    | ColorValueFunc
    | Record<string | symbol, ColorValue>
    | Primitive
  ...
  interface ContainerConfig extends ConfigObject {
    center?: boolean
    padding?: CSSValue | Record<string, CSSValue>
    screens?: Record<string, ScreenValue>
  }

  type WithResolvePathPalette<
    T extends Record<string | symbol, unknown> = Record<string, unknown>,
  ...
  interface Theme {
    ...
    /**
     * {@link https://tailwindcss.com/docs/background-color#changing-the-opacity Reference}
     */
    backgroundOpacity?: Theme["opacity"]
    borderOpacity?: Theme["opacity"]
    divideOpacity?: Theme["opacity"]
  ...
  type ResolvedThemeObject<V = ConfigEntry> = Record<string | symbol, V>
  ...
  interface ResolvedTheme extends ResolvedCustomTheme {
    ...
    backgroundOpacity: ResolvedThemeObject
    borderOpacity: ResolvedThemeObject
    divideOpacity: ResolvedThemeObject
    placeholderOpacity: ResolvedThemeObject
    ringOpacity: ResolvedThemeObject
    textOpacity: ResolvedThemeObject
  }
}
